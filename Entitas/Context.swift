...
public class Context : EntityChangedListener, CustomDebugStringConvertible {
    ...
    public func entityGroup(_ matcher : Matcher) -> Group {
    ...
    public func fillGroupWithEntities(_ group : Group){
    ...
    func componentAdded(_ entity: Entity, component: Component) {
        ...
        if component is UniqueComopnent {
            _ = self.uniqueEntity(Matcher.all(component.cId))
        }
    }
