...
public class Collector: GroupObserver {
    ...
    public func entityAdded(_ entity : Entity) {
        if entityIdToPosition[entity.creationIndex] != nil {
            return
        }
        switch changeType {
        case .removed : return
    ...
    /// Implementation of GroupObserver protocol.
    public func entityRemoved(_ entity : Entity, withRemovedComponent removedComponent : Component) {
        if entityIdToPosition[entity.creationIndex] != nil {
            return
        }
        switch changeType {
    ...
    public func pull(_ amount : Int = -1) -> ArraySlice<Entity> {
