...
/// A ghost protocol which identifies a struct as unique. 
/// While adding a component of this type to an entity
...
public final class Entity : Equatable, CustomDebugStringConvertible {
    ...
    public func get2<C:Component>() -> C? {
        let componentName = C.cId
        if let c = _components[componentName] {
            return c as? C
        }
        return nil
